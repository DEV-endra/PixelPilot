...
env = WebGame()
model = DQN('CnnPolicy', env, tensorboard_log=LOG_DIR, verbose=1, buffer_size=120000,exploration_fraction=0.2,
    exploration_final_eps=0.05)  # Reduced by 10xlearning_starts=1000)
